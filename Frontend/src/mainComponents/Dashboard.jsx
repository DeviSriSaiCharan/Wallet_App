    ...
    <div className="h-full">
      <div className="flex w-full h-16 items-center p-4 justify-between shadow-md">
        ...
        <div className="flex  gap-4 h-12 px-2 justify-between items-center">
          ...
          <Sheet>
            <SheetTrigger className="bg-gray-100 border-[1px] border-black rounded-full w-12 h-full flex justify-center items-center text-2xl">
              U
            </SheetTrigger>
            <SheetContent>
              <SheetHeader>
                ...
                <SheetDescription>
                  <div><h1 className="text-xl">{username}</h1></div>
                </SheetDescription>
              </SheetHeader>
              <SheetBody />
            </SheetContent>
